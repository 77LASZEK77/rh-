...
<body>
  ...
  <main>
    ...
    <section id="kontakt">
      <h2>Kontakt – Centrum Medyczne RH+ Niepołomice</h2>

      <p>
        Zapraszamy do kontaktu z Centrum Medycznym RH+ w celu uzyskania
        szczegółowych informacji, rejestracji wizyt oraz konsultacji
        dotyczących oferowanych usług medycznych.
      </p>

      <h3>Rejestracja telefoniczna</h3>
      <p>
        Kontakt telefoniczny umożliwia szybkie umawianie wizyt,
        zmianę terminów oraz uzyskanie informacji o dostępnych godzinach przyjęć.
      </p>

      <h3>Kontakt mailowy i osobisty</h3>
      <p>
        Pacjenci mogą również skontaktować się mailowo lub osobiście
        w siedzibie placówki w godzinach pracy rejestracji.
        Zachęcamy do wcześniejszego umawiania wizyt.
      </p>

      <h3>Formularz kontaktowy</h3>
      <?php session_start(); $captcha = rand(1000,9999); $_SESSION['captcha'] = $captcha; ?>
      <p>Kod potwierdzający: <span style="user-select: none; font-weight: bold;"><?php echo $captcha; ?></span></p>
      <form action="send_contact.php" method="post">
        ...
        <label for="info">Informacja dla pacjenta:</label>
        ...
        <label for="captcha">Kod potwierdzający:</label>
