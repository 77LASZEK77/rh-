...
<head>
  ...
  <link rel="stylesheet" href="css/informacje.css">
  <script src="js/Informacje.js" defer></script>
</head>
...
<body>
  ...
  <main>
    ...
    <section id="info">
      <h1>Centrum Medyczne RH+ w Niepołomicach</h1>

      <h2>Informacje o placówce</h2>
      <p>
        Centrum Medyczne <strong>RH+ Niepołomice</strong> to nowoczesna placówka,
        której celem jest zapewnienie pacjentom kompleksowej, bezpiecznej
        i dostępnej opieki medycznej. Nasza działalność opiera się na aktualnej
        wiedzy medycznej, doświadczeniu personelu oraz indywidualnym podejściu
        do każdego pacjenta.
      </p>

      <p>
        W RH+ stawiamy na wysoką jakość usług medycznych, komfort leczenia
        oraz przejrzyste zasady rejestracji. Placówka została zaprojektowana
        z myślą o pacjentach w różnym wieku, zarówno mieszkańcach Niepołomic,
        jak i okolicznych miejscowości.
      </p>

      <h3>Nowoczesna opieka medyczna</h3>
      <p>
        Dbamy o to, aby każda wizyta przebiegała w spokojnej atmosferze,
        z poszanowaniem czasu i potrzeb pacjenta. Regularnie rozwijamy
        zakres oferowanych usług medycznych, dostosowując je do potrzeb
