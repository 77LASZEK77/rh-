...
<body>
  ...
  <main>
    ...
    <section id="onas">
      <h2>O nas- Centrum Medyczne RH+</h2>

      <p>
        <strong>Centrum Medyczne RH+</strong> powstało jako odpowiedź
        na rosnące zapotrzebowanie na nowoczesną i dostępną opiekę zdrowotną
        w <strong>Niepołomicach</strong>. Naszym celem było stworzenie miejsca,
        w którym pacjent czuje się bezpiecznie i otrzymuje rzetelną pomoc medyczną.
      </p>

      <p>
        Od początku działalności skupiamy się na jakości leczenia,
        dobrej organizacji pracy oraz przyjaznym podejściu do pacjentów.
        Placówka rozwija się w oparciu o realne potrzeby mieszkańców regionu.
      </p>

      <h3>Nasza misja</h3>
      <p>
        Misją RH+ jest zapewnienie pacjentom profesjonalnej opieki medycznej
        w komfortowych warunkach, z zachowaniem najwyższych standardów
        bezpieczeństwa i etyki zawodowej.
      </p>
    </section>
  </main>
  <footer>
